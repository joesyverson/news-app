...
user01 = User.create(name: "tom", location: "New York", password: "satan", email: "atom.syvo@gmail.com", age: 32)
user02 = User.create(name: "joe", location: "Las Vegas", password: "special", email: "josephgavinsyverson@gmail.com", age: 29)
